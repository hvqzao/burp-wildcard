...
public class BurpExtender implements IBurpExtender, ITab, IExtensionStateListener {
	...
	public void registerExtenderCallbacks(final IBurpExtenderCallbacks callbacks) {
		...
		SwingUtilities.invokeLater(new Runnable() {
			...
			public void run() {
				// images
				ImageIcon iconHelp = new ImageIcon(new ImageIcon(getClass().getResource("/wildcard/panel_help.png")).getImage().getScaledInstance(13, 13, java.awt.Image.SCALE_SMOOTH));
				ImageIcon iconDefaults = new ImageIcon(new ImageIcon(getClass().getResource("/wildcard/panel_defaults.png")).getImage().getScaledInstance(13, 13, java.awt.Image.SCALE_SMOOTH));
				...
				optionsHelpersCSRF.addActionListener(new ActionListener() {
					...
					public void actionPerformed(ActionEvent e) {
						if (optionsHelpersCSRF.isSelected()) {
							...
							new HelperView(burpFrame, "CSRF Handling Burp Extension (Python)", "csrf_handling.py", helpers.bytesToString(streamToBytes(getClass().getResourceAsStream("/wildcard/csrf_handling.py"))));
						}
					}
				});
				//
	...
	public class HelperView extends JDialog {
		...
		private static final long serialVersionUID = -1269440561129383981L;
